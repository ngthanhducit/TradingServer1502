...
namespace TradingServer
{
    ...
    {        
        ...
        /// <returns></returns>
        public static List<Business.OpenTrade> FacadeGetTopClosePosition(int numberGet)
        {
            return Facade.OpenTradeInstance.GetTopClosePosition(numberGet);
        }
        ...
        /// <returns></returns>
        public static Dictionary<int, double> FacadeGetDepositByListInvestorID(List<int> listInvestorID)
        {
            return Facade.OpenTradeInstance.GetDepositByListInvestor(listInvestorID);
        }
        ...
        /// <param name="numberGet"></param>
        /// <returns></returns>
        public static List<Business.OpenTrade> FacadeGetTopClosePosition(int numberGet, List<int> listInvestorID)
        {
            return Facade.OpenTradeInstance.GetTopClosePosition(numberGet, listInvestorID);
        }
        ...
        public static int FacadeAddNewCommandHistory(int InvestorID, int CommandTypeID, string CommandCode, DateTime OpenTime, double OpenPrice, DateTime CloseTime,
                                            ...
                                            double totalSwap, int refCommandID , string AgentRefConfig, bool isActive, bool isStopLossTakeProfit)
        {
            ...
            return Facade.OpenTradeInstance.AddNewCommandHistory(InvestorID, CommandTypeID, CommandCode, OpenTime, OpenPrice, CloseTime, ClosePrice, Profit, Swap,
                                                            ...
                                                            Comment, checkCode, totalSwap, refCommandID, AgentRefConfig, isActive, isStopLossTakeProfit);
        }
